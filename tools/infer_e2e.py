...
MODEL_NAME_DET = './det_repvit_ch.pth'  # 模型文件名称
DOWNLOAD_URL_DET = './'  # 模型文件 URL
MODEL_NAME_REC = './repsvtr_ch.pth'  # 模型文件名称
DOWNLOAD_URL_REC = './'  # 模型文件 URL
MODEL_NAME_REC_SERVER = './fine_svtrv2_ch.pth'  # 模型文件名称
DOWNLOAD_URL_REC_SERVER = './'  # 模型文件 URL
...
def main():
    ...
    text_sys(img_path='../train_data_set', save_dir=save_dir, is_visualize=is_visualize)
